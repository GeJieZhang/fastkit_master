 ...
 */
package com.example.utls.permissions;
...
public class PermissionUtil {
     ...
     * 请求摄像头权限
     */
    public static void launchCamera(RxPermissions rxPermissions, RequestPermission requestPermission) {
        requestPermission(rxPermissions, requestPermission, Manifest.permission.WRITE_EXTERNAL_STORAGE, Manifest.permission.CAMERA);
    }
     ...
     * 请求外部存储的权限
     */
    public static void externalStorage(RxPermissions rxPermissions, RequestPermission requestPermission) {
     ...
     * 请求发送短信权限
     */
    public static void sendSms(RxPermissions rxPermissions, RequestPermission requestPermission) {
        requestPermission(rxPermissions, requestPermission, Manifest.permission.SEND_SMS);
    }
     ...
     * 请求打电话权限
     */
    public static void callPhone(RxPermissions rxPermissions, RequestPermission requestPermission) {
        requestPermission(rxPermissions, requestPermission, Manifest.permission.CALL_PHONE);
    }
     ...
     * 请求获取手机状态的权限
     */
    public static void readPhonestate(RxPermissions rxPermissions, RequestPermission requestPermission) {

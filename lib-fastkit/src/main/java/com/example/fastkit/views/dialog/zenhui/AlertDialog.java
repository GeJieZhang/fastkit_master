package com.example.fastkit.views.dialog.zenhui;
...
public class AlertDialog extends Dialog {
    ...
    public static class Builder {
        ...
        public Builder(Context context) {
            this(context, R.style.kit_dialog);
        }
        ...
        public Builder formBottom(boolean isAnimation){
            if(isAnimation){
                P.mAnimations = R.style.kit_dialog_from_bottom_anim;
            }
        ...
        public Builder addDefaultAnimation(){
            P.mAnimations = R.style.kit_dialog_scale_anim;
            return this;
        }

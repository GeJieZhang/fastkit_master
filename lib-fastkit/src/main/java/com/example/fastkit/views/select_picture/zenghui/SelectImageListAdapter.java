package com.example.fastkit.views.select_picture.zenghui;
...
import com.example.fastkit.views.recyclerview.zenhui.adapter.CommonRecyclerAdapter;
import com.example.fastkit.views.recyclerview.zenhui.adapter.ViewHolder;
...
public class SelectImageListAdapter extends CommonRecyclerAdapter<String> {
    ...
    public SelectImageListAdapter(Context context, List<String> data, ArrayList<String> imageList, int maxCount) {
        super(context, data, R.layout.kit_media_chooser_item);

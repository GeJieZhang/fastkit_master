package com.example.fastkit.views.tree.model;
...
import com.example.fastkit.views.tree.view.AndroidTreeView;
import com.example.fastkit.views.tree.view.TreeNodeWrapperView;
...
public class TreeNode {
    ...
    public static abstract class BaseNodeViewHolder<E> {
        ...
        public ViewGroup getNodeItemsView() {
            return (ViewGroup) getView().findViewById(R.id.kit_node_items);
        }

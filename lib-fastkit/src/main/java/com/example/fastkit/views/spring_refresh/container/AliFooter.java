package com.example.fastkit.views.spring_refresh.container;
...
public class AliFooter extends BaseFooter {
    ...
    public AliFooter(Context context) {
        this(context, 0, R.drawable.kit_arrow, 0, false);
    }

    public AliFooter(Context context, boolean isShowText) {
        this(context, 0, R.drawable.kit_arrow, 0, isShowText);
    }

    public AliFooter(Context context, int logoSrc) {
        this(context, 0, R.drawable.kit_arrow, logoSrc, false);
    }

    public AliFooter(Context context, int logoSrc, boolean isShowText) {
        this(context, 0, R.drawable.kit_arrow, logoSrc, isShowText);
    }
    ...
    public View getView(LayoutInflater inflater, ViewGroup viewGroup) {
        View view = inflater.inflate(R.layout.kit_ali_footer, viewGroup, true);

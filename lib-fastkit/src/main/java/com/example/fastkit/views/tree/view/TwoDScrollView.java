...
public class TwoDScrollView extends FrameLayout {
    ...
    /**
     * Whether kit_arrow scrolling is animated.
     */
   ...
   */
    ...
    /**
     * Handle scrolling in response to an up or down kit_arrow click.
     *
     * @param direction The direction corresponding to the kit_arrow key that was
     *                  pressed

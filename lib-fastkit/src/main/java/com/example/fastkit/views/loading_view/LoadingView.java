...
public class LoadingView extends LinearLayout {
    ...
    private void initLayout() {
        // 1. 记载写好的 kit_ui_loading_view
        // 1.1 实例化View
        // View loadView = inflate(getContext(),R.layout.kit_ui_loading_view,null);
        // 1.2 添加到该View
        // addView(loadView);
        // 找一下 插件式换肤资源加载的那一节的内容
        // this 代表把 kit_ui_loading_view 加载到 LoadingView 中
        inflate(getContext(),R.layout.kit_ui_loading_view,this);
